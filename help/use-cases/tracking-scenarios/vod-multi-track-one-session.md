...
description: Se ett exempel på hur du använder en spårare för att spåra flera sessioner med Media SDK.
...
# VOD en spårningsfunktion för flera sessioner{#vod-one-tracker-for-multiple-sessions}
