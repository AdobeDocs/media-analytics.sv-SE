...
| `Media.close` | **Syntax:** <br/><br/> `s.Media.close(mediaName)` <br/><br/>Avslutar insamling av videodata och skickar information till datainsamlingsservrar i Adobe. Anropa den här metoden i slutet av videon. Den här metoden använder följande parameter: <br/><br/> **mediaName:** Namnet på videon. Det här måste matcha namnet som används i `Media.open`. |
