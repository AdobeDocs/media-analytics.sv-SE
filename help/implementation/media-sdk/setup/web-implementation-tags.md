...
Du kan använda Adobe Media Analytics-tillägget för att implementera Adobe Streaming Media Collection. Media Analytics-tillägget lägger till JavaScript Media SDK (Media 3.x SDK). Det här tillägget innehåller funktioner för att lägga till Media Tracker-instansen till en tagghanterad plats eller ett tagghanterat projekt.
