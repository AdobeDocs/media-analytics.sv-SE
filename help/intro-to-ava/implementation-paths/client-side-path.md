...
Om Media Analytics är den avsedda vägen finns mer information i [Media SDK-implementering](/help/sdk-implement/setup/setup-overview.md) och [Media Collection API.](/help/media-collection-api/mc-api-overview.md)
