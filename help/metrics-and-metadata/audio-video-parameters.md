...
|   Implementering   | Nätverksparametrar | Rapportering |
| --- | --- | --- |
| <ul> <li> **SDK-nyckel:**<br/>  [kanal](./audio-video-parameters.md#config-media-object) </li> <li> **API-nyckel:**<br/> media.channel </li> <li> **Obligatoriskt:**<br/> Ja </li> <li> **Typ:**<br/> sträng </li> <li> **Skickat med:**<br/> Mediestart, mediestängning </li> <li> **Min. SDK-version:** Alla </li> <li> **Exempelvärde:**<br/> &quot;Idrott&quot; </li> <li> **Beskrivning:**<br/> Distributionsstation/kanaler eller var innehållet spelas upp. Alla strängvärden accepteras här.  </li></ul> | <ul> <li> **Adobe Analytics:**<br/> (a.media.channel) </li> <li> **Heartbeats:**<br/> (:sp:schchannel) </li> </ul> | <ul> <li> **Tillgänglig:**<br/> Ja </li> <li> **Reserverad variabel:**<br/> eVar </li> <li> **Förfallotid:**<br/> vid HIT </li> <li> **rapportnamn:**<br/> innehållskanal </li> <li> **Kontextdata:**<br/> (a.media.channel) </li> <li> **datafeed:**<br/> videochchannel </li> <li> **Audience Manager:**<br/> (c_contextdata.<br/>a.media.channel) </li> </ul> |
...
|   Implementering   | Nätverksparametrar | Rapportering |
| --- | --- | --- |
| <ul> <li> **SDK-nyckel:**<br/> Automatiskt angiven</li> <li> **API-nyckel:**<br/> Ej tillämpligt</li> <li> **Typ:**<br/> sträng</li> <li> **Skickat med:**<br/> Mediestart</li> <li> **Min. SDK-version:** Alla</li> <li> **Exempelvärde:**<br/> TRUE </li> <li> **Beskrivning:händelsen**<br/> Load för mediet. (Detta inträffar när användaren klickar på knappen _Spela upp_). Detta skulle räknas även om det finns annonser före rullning, buffring, fel och så vidare.  <br/>**Viktigt:**  Detta kan bara vara sant om det är inställt. Om den inte anges returneras inget värde.  <br/> **Releasedatum: 09/13/18** </li></ul> | <ul> <li> **Adobe Analytics:**<br/> (a.media.view) </li> <li> **Hjärtslag:**<br/> (:event:<br/>stype=start) </li> </ul> | <ul> <li> **Tillgänglig:**<br/> Ja </li> <li> **Reserverad variabel:**<br/> händelse </li> <li> **Rapportnamn:**<br/> Media börjar </li> <li> **Kontextdata:**<br/> (a.media.view) </li> <li> **datafeed:**<br/> videostart </li> <li> **Audience Manager:**<br/> (c_contextdata.<br/>a.media.view) </li> </ul> |
